...
export const GradientWaves: React.FC<GradientWavesProps> = ({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        iTime: { value: 0 },
        iResolution: { value: new Float32Array([container.clientWidth || 800, container.clientHeight || 600]) },
        uSpeed: { value: speed },
        ...
        uHorizonColor: { value: new Float32Array([h[0], h[1], h[2]]) },
        uWaveColor: { value: new Float32Array([w[0], w[1], w[2]]) },
        uCrestColor: { value: new Float32Array([cr[0], cr[1], cr[2]]) }
      }
    });
