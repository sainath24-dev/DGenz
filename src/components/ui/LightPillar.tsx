...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    const qualitySettings = {
      ...
      medium: { iterations: 28, waveIterations: 2, pixelRatio: 0.55, precision: 'mediump', stepMultiplier: 1.4 },
      high: {
        iterations: 40,
        waveIterations: 2,
        pixelRatio: 0.7,
    ...
    try {
      renderer = new THREE.WebGLRenderer({
        ...
        precision: settings.precision as 'mediump' | 'highp',
        stencil: false,
        depth: false
      });
    } catch {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        float alpha = clamp(lum * 3.0, 0.0, 0.95);
