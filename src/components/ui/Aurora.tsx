...
const Aurora: React.FC<AuroraProps> = ({
  colorStops = ['#84CC16', '#10B981', '#06B6D4'],
  amplitude = 1.0,
  blend = 0.5,
  speed = 1.0,
  time,
  ...
  useEffect(() => {
    ...
    if (geometry.attributes && 'uv' in geometry.attributes) {
    ...
    const update = (t: number) => {
      ...
      const currentTime = currentProps.time ?? t * 0.001;
      const currentSpeed = currentProps.speed ?? 1.0;
      program.uniforms.uTime.value = currentTime * currentSpeed * 0.3;
